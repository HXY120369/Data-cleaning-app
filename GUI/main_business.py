...
class BusinessData:
    def __init__(self, master):
        ...
        # 加载所需要的图片
        image_paths = ["images/image_business.png",
        ...
        self.label1 = ttk.Label(left_top_frame, text="生产计划与调度数据", width=15)
        self.label1.grid(column=0, row=1, padx=10, pady=5)
        self.label2 = ttk.Label(left_top_frame, text="销售与客户数据", width=15)
        self.label2.grid(column=0, row=2, padx=10, pady=5)
        self.label3 = ttk.Label(left_top_frame, text="供应链数据", width=15)
    ...
    def know_more(self):
        ...
        knowledge_window.title("关于‘业务’的数据")
        ...
        sample_text = '''生产计划与调度数据：是工业生产中用于规划和组织生产活动的数据，包括计划生产的产品种类、数量、交货期等生产计划信息，以及生产任务分配、设备和人员调度安排等调度信息，以保障生产活动有序高效进行。
        供应链数据：涉及工业生产中供应链各个环节的相关数据，包括供应商信息（名称、地址、联系方式、供应产品种类和价格等）、采购订单数据（采购数量、采购价格、交货期等）以及物流运输数据（货物运输状态、运输路线、运输时间等），对优化供应链管理和保障生产连续性起着关键作用。
        销售与客户数据：是工业生产企业在销售环节和客户关系管理中产生的数据，包括产品的销售数量、销售价格、销售渠道、销售区域等销售数据，以及客户基本信息（名称、地址、联系方式等）、客户订单信息、客户投诉和反馈信息等客户数据，有助于企业了解市场和客户需求，提升销售业绩和客户满意度。'''
